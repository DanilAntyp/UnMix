...
export function LiquidMetalButton({
  ...
  return (
    <div style={{ position: 'relative', display: 'inline-block', opacity: disabled ? 0.55 : 1 }}>
      <div style={{ perspective: '1000px', perspectiveOrigin: '50% 50%' }}>
        ...
        >
          ...
          >
            {viewMode === 'icon' ? (
              <Sparkles size={16} style={{ color: '#8e8e8e', filter: 'drop-shadow(0px 1px 2px rgba(0,0,0,0.5))' }} />
            ) : (
              <span
                style={{
                  fontSize: '14px', color: '#9a9a9a', fontWeight: 500,
                  textShadow: '0px 1px 2px rgba(0,0,0,0.5)', whiteSpace: 'nowrap',
                }}
              >
                {label}
              </span>
